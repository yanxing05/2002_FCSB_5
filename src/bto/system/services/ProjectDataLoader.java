...
public class ProjectDataLoader {
    ...
    public ProjectDataLoader(CSVFileService csvFileService, UserService userService, OfficerService officerService) {
        ...
        for (int i = 1; i < data.size(); i++) {
            ...
            if (row.size() >= 13) {
                ...
                if (officersStr != null && !officersStr.isEmpty()) {
                    // Remove quotes if field is like "Daniel,Emily"
